...
namespace Logic.Behaviors.Validators.ForProfiles {
	public class CreateStageProfileExemplarCommandValidator : AbstractValidator<CreateStageProfileExemplarCommand> {
		public CreateStageProfileExemplarCommandValidator() {
